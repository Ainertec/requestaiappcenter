...
var SessionController = /** @class */ (function () {
    function SessionController(sessionUseCase) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.sessionUseCase.createSession(username, password)];
                    case 2:
                        res = _b.sent();
                        return [2 /*return*/, response.json(res)];
                    case 3:
                        error_1 = _b.sent();
                        return [2 /*return*/, response.status(401).json(error_1.message)];
