...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (request, responseHttp) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, password, question, response, username, admin, userId, userAdm, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, password = _a.password, question = _a.question, response = _a.response, username = _a.username, admin = _a.admin;
    ...
    UserController.prototype.update = function (request, responseHttp) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, password = _a.password, username = _a.username, admin = _a.admin, question = _a.question, response = _a.response;
